...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jumbo = __webpack_require__(160);

	var _jumbo2 = _interopRequireDefault(_jumbo);

	var _file_process = __webpack_require__(161);

	var _file_process2 = _interopRequireDefault(_file_process);

	var _sync = __webpack_require__(162);

	var _sync2 = _interopRequireDefault(_sync);

	var _file_process_form = __webpack_require__(163);

	var _file_process_form2 = _interopRequireDefault(_file_process_form);

	var _file_list = __webpack_require__(164);

	var _file_list2 = _interopRequireDefault(_file_list);

	var _file_list_item = __webpack_require__(165);

	var _file_list_item2 = _interopRequireDefault(_file_list_item);

	var _footer = __webpack_require__(166);

	var _footer2 = _interopRequireDefault(_footer);

	var _table_row = __webpack_require__(167);
	...
	var Main = function (_Component) {
	  ...
	  function Main(props) {
	    ...
	    _this.datas = ["Student Record", "Weather Record", "Finance Record"];
	    ...
	    _this.onInputSaveClick = _this.onInputSaveClick.bind(_this);
	    _this.changeDatasInput = _this.changeDatasInput.bind(_this);
	    return _this;
	  }

	  _createClass(Main, [{
	    key: 'onInputChange',
	    value: function onInputChange(workbook) {
	      var XL_row_object = void 0,
	          header = void 0;
	    ...
	    key: 'onInputSaveClick',
	    value: function onInputSaveClick() {
	    ...
	    key: 'changeDatasInput',
	    value: function changeDatasInput() {}
	    // this.setState = {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_file_process_form2.default, { onExcelSelect: this.onInputChange, onSaveClick: this.onInputSaveClick })
	        ),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(_table_row2.default, { row: this.state.data })
	              ),
	              _react2.default.createElement(
	                'tbody',
	                null,
	                this.state.table.map(function (datas, i) {
	                  ...
	                  return _react2.default.createElement(_table_row2.default, { row: datas, key: i });
	                })
	              )
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-lg-2' },
	            _react2.default.createElement(_file_list2.default, { changeData: this.changeDatasInput, datas: this.datas /*real data bind here*/ })
	          )
	        ),
	        (0, _footer2.default)()
	      );
	...
	_reactDom2.default.render(_react2.default.createElement(Main, null), document.querySelector('#main'));
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "small",
	                null,
	                "Excel reader app that can store on local browser #React"
	            )
	        )
	    );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileProcess = function (_Component) {
	    _inherits(FileProcess, _Component);

	    function FileProcess(props) {
	        _classCallCheck(this, FileProcess);

	        return _possibleConstructorReturn(this, (FileProcess.__proto__ || Object.getPrototypeOf(FileProcess)).call(this, props));
	    }

	    _createClass(FileProcess, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'row justify-content-md-center' },
	                _react2.default.createElement(_sync2.default, null),
	                _react2.default.createElement(_file_process_form2.default, null)
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Sync = function (_Component) {
	    ...
	    function Sync(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (Sync.__proto__ || Object.getPrototypeOf(Sync)).call(this, props));

	        _this.state = { isOnlineToggle: "btn btn-outline-primary mr-sm-2" };
	        _this.isOnline = _this.isOnline.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Sync, [{
	        ...
	        value: function isOnline() {
	            var val = navigator.onLine ? "btn btn-outline-primary mr-sm-2" : "btn btn-outline-danger mr-sm-2 disabled";
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "button",
	                { className: this.state.isOnlineToggle,
	                    type: "button",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileProcessForm = function (_Component) {
	    _inherits(FileProcessForm, _Component);

	    function FileProcessForm(props) {
	        _classCallCheck(this, FileProcessForm);

	        var _this = _possibleConstructorReturn(this, (FileProcessForm.__proto__ || Object.getPrototypeOf(FileProcessForm)).call(this, props));

	        _this.state = {};
	        _this.fileProcess = _this.fileProcess.bind(_this);
	        _this.fileSave = _this.fileSave.bind(_this);
	        return _this;
	    }

	    _createClass(FileProcessForm, [{
	        key: 'fileProcess',
	        value: function fileProcess(e) {
	            var _this2 = this;
	            ...
	            reader.onload = function (e) {
	                ...
	                _this2.props.onExcelSelect(workbook);
	            };
	            reader.readAsBinaryString(file);
	        }
	    }, {
	        key: 'fileSave',
	        value: function fileSave(e) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { className: 'form-control mr-sm-2', type: 'file', onChange: this.fileProcess }),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-outline-success', type: 'button', onClick: this.fileSave },
	                    'Save'
	                )
	            );
	        }
	    ...
	    return FileProcessForm;
	}(_react.Component);

	exports.default = FileProcessForm;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileList = function FileList(props) {
	    var result = props.datas.map(function (data, i) {
	        return _react2.default.createElement(_file_list_item2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileListItem = function FileListItem(props) {
	    return _react2.default.createElement(
	        "button",
	        { className: "list-group-item list-group-item-action", type: "button", onClick: function onClick() {
	                props.changeDataInput(props.data);
	            } },
	        "Records"
	    );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _table_cell = __webpack_require__(168);
	...
	var TableRow = function TableRow(props) {
	    var result = props.row.map(function (cell) {
	        return _react2.default.createElement(_table_cell2.default, { data: cell, key: cell.toString() });
	    });
	    return _react2.default.createElement(
	        'tr',
	        null,
